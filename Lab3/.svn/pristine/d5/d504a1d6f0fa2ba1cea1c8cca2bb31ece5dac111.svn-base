...
typedef struct {
  ...
  volatile float dt;
  volatile unsigned int highLinkSetPoint;
  volatile unsigned int lowLinkSetPoint;
  volatile signed int highLinkPIDOut;
  volatile signed int lowLinkPIDOut;
  volatile unsigned char PIDTimerMaxCount;
  volatile unsigned char PIDTimerCurrentCount;
} PidConst;
