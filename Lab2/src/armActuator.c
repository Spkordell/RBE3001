...
void setLinkAngle(char link, float angle) {
	if (link == 'H') {
		globals.highLinkSetPoint = ((float)HIGH_POT_ADC_RANGE/90)*angle + HIGH_POT0_ADC_CENTER;
	} else if(link == 'L'){
