...
PidConst pidConst;
/*
 * This function initializes variables used by the PID controller
 */
...
/*
 * This function allows one to set the PID constants for a given link for the PID controller
 */
...
/*
 * This function performs the PID calculations
 */
...
/*
 * This function starts the timer which allows for the cacluatlion of PID at regular intervals
 */
void startPID() {
...
/*
 * This is the timer ISR, which computes the PID and updates the motor voltages accordingly
 */
