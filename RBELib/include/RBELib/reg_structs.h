 ...
 * @file reg_structs.h
 *
 * @brief This file redefines all of the registers of the ATmega644p as structs
...
/**
 * @brief Register: TIFR0 - Timer/Counter 0 Interrupt Flag Register. Page: 102
 */
typedef union {
	struct {
		unsigned _TOV0	:1;
...
/**
 * @brief Register: TIFR1- Timer/Counter1 Interrupt Flag Register. Page: 131
 */
typedef union {
	struct {
		unsigned _TOV1	:1;
...
/**
 * @brief Register: TIFR2 - Timer/Counter2 Interrupt Flag Register. Page: 152
 */
typedef union {
	struct {
		unsigned _TOV2	:1;
...
/**
 * @brief Register: PCIFR- Pin Change Interrupt Flag Register. Page: 62
 */
typedef union {
	struct {
		unsigned _PCIF0	:1;
...
/**
 * @brief Register: EIFR - External Interrupt Flag Register. Page: 61
 */
typedef union {
	struct {
		unsigned _INTF0	:1;
...
/**
 * @brief Register: EIMSK - External Interrupt Mask Register. Page: 61
 */
typedef union {
	struct {
		unsigned _INT0	:1;
...
/**
 * @brief Register: GPIOR0 - General Purpose I/O Register 0. Page: 26
 */
typedef union {
	struct {
		unsigned _b0	:1;
...
/**
 * @brief Register: EECR - The EEPROM Control Register. Page: 21
 */
typedef union {
	struct {
		unsigned _EERE	:1;
...
/**
 * @brief Register: EEAR - The EEPROM Address Register. Page: 21
 */
typedef union {
	struct {
		unsigned _low	:8;
...
/**
 * @brief Register: GTCCR - General Timer/Counter Control Register. Page: 153
 */
typedef union {
	struct {
		unsigned _PSRSYNC	:1;
...
/**
 * @brief Register: TCCR0A -- Timer/Counter Control Register A. Page: 97
 */
typedef union {
	struct {
		unsigned _WGM00	:1;
...
/**
 * @brief Register: TCCR0B - Timer/Counter Control Register B. Page: 100
 */
typedef union {
	struct {
		unsigned _CS00	:1;
...
/**
 * @brief Register: SPCR - SPI Control Register. Page: 161
 */
typedef union {
	struct {
		unsigned _SPR0	:1;
...
/**
 * @brief Register: SPSR - SPI Status Register. Page: 162
 */
typedef union {
	struct {
		unsigned _SPI2X	:1;
...
/**
 * @brief Register: ACSR - Analog Comparator Control and Status Register. Page: 231
 */
typedef union {
	struct {
		unsigned _ACIS0	:1;
...
/**
 * @brief Register: OCDR - On-chip Debug Register. Page: 258
 */
typedef union {
	struct {
		unsigned _OCDR0	:1;
...
/**
 * @brief Register: SMCR - Sleep Mode Control Register. Page: 43
 */
typedef union {
	struct {
		unsigned _SE	:1;
...
/**
 * @brief Register: MCUSR - MCU Status Register. Page: 52
 */
typedef union {
	struct {
		unsigned _PORF	:1;
...
/**
 * @brief Register: MCUCR - MCU Control Register. Page: 58
 */
typedef union {
	struct {
		unsigned _IVCE	:1;
...
/**
 * @brief Register: SPMCSR - Store Program Memory Control and Status Register. Page: 281
 */
typedef union {
	struct {
		unsigned _SPMEN		:1;
...
/**
 * @brief Register: WDTCSR - Watchdog Timer Control Register. Page: 52
 */
typedef union {
	struct {
		unsigned _WDP0	:1;
...
/**
 * @brief Register: CLKPR - Clock Prescale Register. Page: 37
 */
typedef union {
	struct {
		unsigned _CLKPS0	:1;
...
/**
 * @brief Register: PRR - Power Reduction Register. Page: 44
 */
typedef union {
	struct {
		unsigned _PRADC		:1;
...
/**
 * @brief Register: PCICR - Pin Change Interrupt Control Register. Page: 62
 */
typedef union {
	struct {
		unsigned _PCIE0	:1;
...
/**
 * @brief Register: EICRA - External Interrupt Control Register A. Page: 60
 */
typedef union {
	struct {
		unsigned _ISC00	:1;
...
/**
 * @brief Register: PCMSK0 - Pin Change Mask Register 0. Page: 64
 */
typedef union {
	struct {
		unsigned _PCINT0:1;
...
/**
 * @brief Register: PCMSK1 - Pin Change Mask Register 1. Page: 63
 */
typedef union {
	struct {
		unsigned _PCINT8:1;
...
/**
 * @brief Register: PCMSK2 - Pin Change Mask Register 2. Page: 63
 */
typedef union {
	struct {
		unsigned _PCINT16:1;
...
/**
 * @brief Register: TIMSK0 - Timer/Counter Interrupt Mask Register. Page: 101
 */
typedef union {
	struct {
		unsigned _TOIE0	:1;
...
/**
 * @brief Register: TIMSK1 - Timer/Counter1 Interrupt Mask Register. Page: 130
 */
typedef union {
	struct {
		unsigned _TOIE1	:1;
...
/**
 * @brief Register: TIMSK2 - Timer/Counter2 Interrupt Mask Register. Page: 152
 */
typedef union {
	struct {
		unsigned _TOIE2		:1;
...
/**
 * @brief Register: PCMSK3 - Pin Change Mask Register 3. Page: 63
 */
typedef union {
	struct {
		unsigned _PCINT24:1;
...
/**
 * @brief Register: ADCSRA - ADC Control and Status Register A. Page: 249
 */
typedef union {
	struct {
		unsigned _ADPS0	:1;
...
/**
 * @brief Register: ADCSRB - ADC Control and Status Register B. Page: 251
 */
typedef union {
	struct {
		unsigned _ADTS0	:1;
...
/**
 * @brief Register: ADMUX - ADC Multiplexer Selection Register. Page: 248
 */
typedef union {
	struct {
		unsigned _MUX0	:1;
...
/**
 * @brief Register: DIDR0 - Digital Input Disable Register 0. Page: 252
 */
typedef union {
	struct {
		unsigned _ADC0D	:1;
...
/**
 * @brief Register: DIDR1 - Digital Input Disable Register 1. Page: 232
 */
typedef union {
	struct {
		unsigned _AIN0D	:1;
...
/**
 * @brief Register: TCCR1A - Timer/Counter1 Control Register A. Page: 125
 */
typedef union {
	struct {
		unsigned _WGM10		:1;
...
/**
 * @brief Register: TCCR1B - Timer/Counter1 Control Register B. Page: 127
 */
typedef union {
	struct {
		unsigned _CS10	:1;
...
/**
 * @brief Register: TCCR1C - Timer/Counter1 Control Register C. Page: 128
 */
typedef union {
	struct {
		unsigned 		:6;
...
/**
 * @brief Register: TCCR2A - Timer/Counter Control Register A. Page: 146
 */
typedef union {
	struct {
		unsigned _WGM20		:1;
...
/**
 * @brief Register: TCCR2B - Timer/Counter Control Register B-. Page: 149
 */
typedef union {
	struct {
		unsigned _CS20	:1;
...
/**
 * @brief Register: ASSR - Asynchronous Status Register. Page: 150
 */
typedef union {
	struct {
		unsigned _TCR2BUB	:1;
...
/**
 * @brief Register: TWSR - TWI Status Register. Page: 227
 */
typedef union {
	struct {
		unsigned _TWPS0	:1;
...
/**
 * @brief Register: TWAR - TWI (Slave) Address Register. Page: 228
 */
typedef union {
	struct {
		unsigned _TWGCE	:1;
...
/**
 * @brief Register: TWCR - TWI Control Register. Page: 225
 */
typedef union {
	struct {
		unsigned _TWIE	:1;
...
/**
 * @brief Register: TWAMR - TWI (Slave) Address Mask Register. Page: 228
 */
typedef union {
	struct {
		unsigned _TWAM0	:1;
...
/**
 * @brief Register: UCSR0A - USART Control and Status Register 0 A. Page: 182
 */
typedef union {
	struct {
		unsigned _MPCM0	:1;
...
/**
 * @brief Register: UCSR0B - USART Control and Status Register 0 B. Page: 183
 */
typedef union {
	struct {
		unsigned _TXB80		:1;
...
/**
 * @brief Register: UCSR0C - USART Control and Status Register 0 C. Page: 184
 */
typedef union {
	struct {
		unsigned _UCPOL0	:1;
...
/**
 * @brief Register: UCSR1A - USART MSPIM Control and Status Register 1 A. Page: 196
 */
typedef union {
	struct {
		unsigned _MPCM1	:1;
...
/**
 * @brief Register: UCSR1B - USART MSPIM Control and Status Register 1 B. Page: 197
 */
typedef union {
	struct {
		unsigned _TXB81		:1;
...
/**
 * @brief Register: UCSR1C - USART MSPIM Control and Status Register 1 C. Page: 197
 */
typedef union {
	struct {
		unsigned _UCPOL1	:1;
